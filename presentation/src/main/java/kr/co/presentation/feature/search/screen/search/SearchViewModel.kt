...
data class SearchScreenState(
    ...
    val diaries: List<SearchDiaryUiModel> = emptyList(),
...
sealed interface SearchAction {
    ...
    data class DiaryClicked(val diary: SearchDiaryUiModel) : SearchAction
...
class SearchViewModel @Inject constructor(
    ...
    private fun initLoadDiaries() = intent {
        ...
        getPagedDiaries(
            ...
            val uiModels = list.map { it.toSearchDiaryUiModel() }
            reduce {
                state.copy(
                    diaries = uiModels,
                    isLoading = false,
