...
import kr.co.presentation.feature.diary.composable.DiaryDeleteDialog
import kr.co.presentation.feature.diary.composable.SkeletonDiaryPreviewContent
...
fun DiaryPreviewScreen(
    ...
    if (state.showDeleteDialog) {
        DiaryDeleteDialog(
            onConfirm = { viewModel.handleAction(DiaryPreviewAction.DeleteConfirmed) },
            onDismiss = { viewModel.handleAction(DiaryPreviewAction.DeleteCancelled) }
        )
    }
...
fun DiaryPreviewContent(
    ...
    Scaffold(
        ...
        topBar = {
            PreviewTopBar(diary.date, onAction, onBack)
        },
        floatingActionButton = {
            FloatingActionButton(
                onClick = { onAction(DiaryPreviewAction.EditClicked) },
        ...
        Box {
            ...
            DropdownMenu(
                ...
                DropdownMenuItem(
                    ...
                    onClick = {
                        showMenu = false
                        onAction(DiaryPreviewAction.DeleteClicked)
                    },
                )
            }
        }
