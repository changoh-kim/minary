...
abstract class DiaryDao {
     ...
     */
    @Transaction
    open suspend fun insertDiaryWithRelations(
        diary: DiaryEntity,
     ...
     */
    @Transaction
    open suspend fun updateDiaryWithRelations(
        diary: DiaryEntity,
        emotions: List<DiaryEmotionEntity>,
        imageUrls: List<DiaryImageUrlEntity>
    ) {
     ...
     */
    @Transaction
    open suspend fun upsertDiaryWithRelations(
        entry: DiaryWithRelations,
    ) {
     ...
     */
    @Transaction
    open suspend fun upsertDiariesWithRelations(
     ...
     */
    @Transaction
    open suspend fun upsertDiariesWithRelationsFromRaw(
    ...
    abstract suspend fun deleteDiary(id: String): Int
    ...
    abstract suspend fun deleteDiariesByIds(ids: List<String>): Int
     ...
     */
    @Delete
    abstract suspend fun deleteDiary(diary: DiaryEntity): Int
     ...
     */
    @Delete
    abstract suspend fun deleteDiaries(diaries: List<DiaryEntity>): Int
    ...
    abstract suspend fun deleteOldDiaries(cutoff: Long): Int
    ...
    abstract suspend fun getDiary(id: String): DiaryEntity?
    ...
    abstract suspend fun getDiary(date: LocalDate): DiaryEntity?
    ...
    abstract suspend fun getEmotions(diaryId: String): List<DiaryEmotionEntity>
    ...
    abstract suspend fun getImageUrls(diaryId: String): List<DiaryImageUrlEntity>
    ...
    abstract suspend fun getDiaryWithRelations(id: String): DiaryWithRelations?
    ...
    abstract suspend fun getDiaryWithRelations(date: LocalDate): DiaryWithRelations?
    ...
    abstract fun getDiaryWithRelationsFlow(id: String): Flow<DiaryWithRelations?>
    ...
    abstract fun getDiaryWithRelationsFlow(date: LocalDate): Flow<DiaryWithRelations?>
    ...
    abstract suspend fun getAllDiariesWithRelations(): List<DiaryWithRelations>
    ...
    abstract fun getAllDiariesWithRelationsFlow(): Flow<List<DiaryWithRelations>>
    ...
    abstract suspend fun getDiariesByDateRangeWithRelations(
        startDate: LocalDate,
        endDate: LocalDate
    ...
    abstract fun getDiariesByDateRangeWithRelationsFlow(
        startDate: LocalDate,
        endDate: LocalDate
    ...
    abstract suspend fun getPendingDiariesWithRelations(limit: Int = 50): List<DiaryWithRelations>
    ...
    abstract suspend fun getDiaryCountByDateRange(startDate: LocalDate, endDate: LocalDate): Int

    @Query("SELECT COUNT(*) FROM ${DiaryEntity.TABLE_NAME}")
    abstract suspend fun getTotalDiaryCount(): Int
    ...
    abstract suspend fun getAllDiaryDates(): List<LocalDate>
    ...
    abstract suspend fun getTotalWordCount(): Int
    ...
    abstract fun getWordTotalCountFlow(): Flow<Int>
    ...
    abstract suspend fun getMostFrequentEmotionStats(): EmotionStats?
    ...
    abstract suspend fun getLeastFrequentEmotionStaus(): EmotionStats?
    ...
    @Query("""
        ...
        ORDER BY count DESC
    """)
    abstract suspend fun getEmotionStatistics(): List<EmotionStats>
    ...
    @Query("""
        ...
        LIMIT 1
    """)
    abstract suspend fun getEmotionStatisticsByDateRange(
        startDate: LocalDate,
        endDate: LocalDate
    ): EmotionStats?
    ...
    abstract suspend fun getSyncStatus(id: String): DiarySyncStatus?

    /**
     * 특정 일기의 동기화 상태를 조회합니다.
     */
    suspend fun getSyncStatus(diary: DiaryEntity): DiarySyncStatus? {
    ...
    abstract suspend fun searchDiariesPaged(
        query: String,
        startDate: LocalDate?,
        endDate: LocalDate?,
        limit: Int,
    ...
    abstract suspend fun getAllDiariesPaged(
        limit: Int,
        offset: Int
    ): List<DiaryWithRelations>
    ...
    abstract suspend fun getLastSyncedAt(): Long?
    ...
    abstract suspend fun getPendingItemCount(): Int
    ...
    abstract fun getPendingItemCountFlow(): Flow<Int>
    ...
    abstract suspend fun markAsSynced(id: String): Int
    ...
    abstract suspend fun markAsSynced(date: LocalDate): Int
    ...
    abstract suspend fun markAsSyncedByIds(ids: List<String>): Int
    ...
    abstract suspend fun getLastModifiedAt(): Long

    open suspend fun markAsSynced(diaries: List<DiaryEntity>) {
